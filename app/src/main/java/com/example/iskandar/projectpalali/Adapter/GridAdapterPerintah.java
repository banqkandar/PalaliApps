...
public class GridAdapterPerintah extends RecyclerView.Adapter<GridAdapterPerintah.ViewHolder> implements Filterable {

    ArrayList<Item> mItems, filterlist;
    Context context;

    public GridAdapterPerintah(Context context, ArrayList<Item> mItems) {
